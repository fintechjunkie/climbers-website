...
Token: `{{LOC:THE_PRISM}}`
Required file: `loc-the-prism.png`

Use `loc-the-prism.png` as the required visual reference whenever this location appears. Preserve the exact layout, palette and construction. 
...
1. Generate the canonical image. One figure, plain
   ...
   a plate.
2. Save it in this folder as exactly `loc-the-prism.png`.
3. Paste the description into `block` for `THE_PRISM` in
