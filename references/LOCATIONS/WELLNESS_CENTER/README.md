# the Wellness and Optimization Center

Token: `{{LOC:WELLNESS_CENTER}}`
Required file: `loc-wellness-center.png`

Use `loc-wellness-center.png` as the required visual reference whenever this location appears. Preserve the exact layout, palette and construction. 

**Status: NOT LOCKED — no canonical image yet.**

## What this has to hold

Calm institutional facade, atrium with a reflecting pool, intake desk. Designed to look like medicine. t2 opener and spreads 1-4.
...
1. Generate the canonical image. One figure, plain
   ...
   a plate.
2. Save it in this folder as exactly `loc-wellness-center.png`.
3. Paste the description into `block` for `WELLNESS_CENTER` in
