# Block 44, street level

Token: `{{LOC:BLOCK_44_SURFACE}}`
Required file: `loc-block-44-surface.png`

Use `loc-block-44-surface.png` as the required visual reference whenever this location appears. Preserve the exact layout, palette and construction. 

**Status: NOT LOCKED — no canonical image yet.**

## What this has to hold

p2 opener and spread 2.
...
1. Generate the canonical image. One figure, plain
   ...
   a plate.
2. Save it in this folder as exactly `loc-block-44-surface.png`.
3. Paste the description into `block` for `BLOCK_44_SURFACE` in
