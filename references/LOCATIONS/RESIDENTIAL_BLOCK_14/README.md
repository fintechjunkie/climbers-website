# Residential Block 14, third floor

Token: `{{LOC:RESIDENTIAL_BLOCK_14}}`
Required file: `loc-residential-block-14.png`

Use `loc-residential-block-14.png` as the required visual reference whenever this location appears. Preserve the exact layout, palette and construction. 

**Status: LOCKED.**

## What this has to hold

Narrow stairwell, third-floor hallway, a radiator with dried protein strips on it. t1 spread 4.
...
1. Generate the canonical image. One figure, plain
   ...
   a plate.
2. Save it in this folder as exactly `loc-residential-block-14.png`.
3. Paste the description into `block` for `RESIDENTIAL_BLOCK_14` in
