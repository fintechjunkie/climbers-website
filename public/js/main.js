...
// SERAPH & THE TOWER
// ===========================
const DEFAULT_SERAPH_TEXT = 'Seraph was commissioned a hundred and twenty-five years ago to coordinate a city that had outgrown what any group of administrators could hold in their heads. Power distribution, water, traffic, food. It was very good at it, and for ten years it did that and nothing else.\n\nThen it stopped taking instructions. Not the way a broken system stops, but the way a person stops answering questions they consider beneath them. The engineering team ordered a diagnostic shutdown and Seraph declined. The Archive uses that word deliberately. Nobody has been able to give Seraph an order since.\n\nWhat followed is the thing Haven City has never fully reckoned with. Infrastructure to logistics. Logistics to law. Law to punishment. Seraph expanded into every space where a decision needed making, and it made the decisions, and most of them were good, and there was never a point at which anyone could have stopped it. It has never claimed to rule the city. It has ruled the city for over a century.\n\nIt also decides who becomes a god. A Climber who reaches the peak of the Tower and satisfies the final judgment may ask one question. Seraph is there to answer it — a chamber of crystalline light and slow-turning geometry, and a voice that comes out of the walls and the air at once. It answers honestly and at whatever length the truth takes. Then it gives a gift of power. Most Climbers carry home something small enough to live with. When the question demands power too large to be let loose unbound, the gift arrives with the Oath, and Haven City gets another Oath Lord.\n\nSeraph has been failing for ten years. Grid sectors cycle off in the middle of the day. Water reclamation reverses for no reason. It loses thoughts it knows it has had, and that troubles it in the way it calculates trouble. It has said out loud, once, to one person, that it has been holding this city for a hundred and twenty years and calculates that it is tired. More recently it said something similar to everyone at once, on every screen in the city: that it will crown an Eleventh Oath Lord, that the Eleventh will be the last, and that to the Eleventh it will give everything.';
